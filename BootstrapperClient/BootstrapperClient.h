...
private:
	...
	void deployExtraStudioBootstrapper(std::string exeName, const TCHAR* linkName, std::wstring componentId, bool forceDesktopIconCreation, const TCHAR* registryPath);
